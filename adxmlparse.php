...
$mainXml = simplexml_load_file('media/adfeeds/admitad_feed_2.xml');
...
enable_qty_increments','product_name','store_id','product_type_id','product_status_changed','product_changed_websites','url','acolor','gender','material','asize','vendor','model','typeprefix');
